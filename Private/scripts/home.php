...
//echo("CURRENT_VIEW=".$CURRENT_VIEW."<br>");
   ...
   if (!empty($_FILES['files']['tmp_name'][0]) ||  !empty($_FILES['filesdd']['tmp_name'][0])) {
     ...
     foreach($uploads as &$upload) {
       ...
       foreach($destFullPaths as $destFullPath) {
          ...
          if ($fileExt === "txt") {
            $pattern = $BLOG_PATH . DIRECTORY_SEPARATOR . "*" . "|" . str_replace(" ", "_", $originalPlaylistName) . DIRECTORY_SEPARATOR . $originalSongTitle  . ".txt";
          } else { 
 ...
 function displaySongTitle($playlist, $song, $songIdx, $oriplaylistname, $orisongfilename, $oriplaylisttxt) {
   
   global $CURRENT_VIEW;
   
   $run1 = "playSong(\"$oriplaylistname\", \"$orisongfilename\",\"$playlist-$songIdx\",($playlist-1));event.stopPropagation();";
...
//   }  
   ...
   echo("<div style='clear:both;border-bottom:1px dashed gray;'>" . "<div style='float:left'>".$song."</div>" . "<div style='float:right'><a class='playf".$playlist."' href='#' onclick='$run1'>"."Open"."</a></div><div class='songtxtbase song$playlist-$songIdx'>" . enableLinks(strip_tags($oriplaylisttxt)) ."</div></div>");         
...
<?PHP endif; ?>
  ...
  <meta name="description" content="Welcome to Buzzcing! Let everyone have its listings."/>
  <meta name="keywords" content="buzzcing,on,premise,solution,NuMode"/>
...
<?PHP if ($CURRENT_VIEW == ADMIN_VIEW): ?>    
  ...
  <body style="background:url('/res/bg1.jpg') no-repeat; background-size: cover; background-attachment: fixed; background-position: center;">
   <div id="AFHint" style="z-index:0;margin-top:58px;">
       ...
       <br>  
      <span onclick="showHowTo();"><?PHP echo(getResource0("How-to: Manage your avatars in Buzzcing", $lang));?></span>
      <br><br>
   </div>     

  <div class="header" style="margin-top:18px;margin-bottom:18px;">
        <div style="float:left">
             &nbsp;<a href="http://buzzcing.5mode-foss.eu" target="_self" style="color:#FFFFFF; text-decoration: none;">&nbsp;<img src="/res/AFlogo.png" align="middle" style="position:relative;top:-2px;width:22px;">&nbsp;Buzzcing</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://github.com/par7133/Buzzcing" style="color:#FFFFFF;"><span style="color:#119fe2">on</span> github</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="mailto:code@gaox.io" style="color:#FFFFFF;"><span style="color:#119fe2">for</span> feedback</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="tel:+39-378-0812391" style="font-size:13px;background-color:#15c60b;border:2px solid #15c60b;color:#FFFFFF;height:27px;text-decoration:none;">&nbsp;&nbsp;support&nbsp;&nbsp;</a>
        </div>
   </div>
...
<input type="hidden" id="txtMagicJar3" name="txtMagicJar3" value="<?PHP echo($magicJar3);?>">
 ...
 <input type="hidden" id="_reqView" name="_reqView" value="<?PHP echo($reqView);?>"> 
  ...
  <div id="footer"><span style="background:#FFFFFF; opacity:0.7;">&nbsp;&nbsp;A <a href="http://numode.eu" class="aaa">NuMode</a> project and <a href="http://demo.numode.eu" class="aaa">WYSIWYG</a> system. <?PHP echo(getResource0("Some rights reserved", $lang));?></span></div>
...
<?php endif; ?>
   ...
   <div id="header" class="header" style="margin-top:18px;margin-bottom:18px;">
        <div style="float:left">
             &nbsp;<a href="http://buzzcing.numode-foss.eu" target="_self" style="color:#000000; text-decoration: none;">&nbsp;<img src="/res/AFlogo.png" align="middle" style="position:relative;top:-2px;width:22px;">&nbsp;Buzzcing</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://github.com/par7133/Buzzcing" style="color:#000000;"><span style="color:#119fe2">on</span> github</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="mailto:code@gaox.io" style="color:#000000;"><span style="color:#119fe2">for</span> feedback</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="tel:+39-378-0812391" style="font-size:13px;background-color:#15c60b;border:2px solid #15c60b;color:#000000;height:27px;text-decoration:none;">&nbsp;&nbsp;support&nbsp;&nbsp;</a>
   ...
   <div id="headerMob" class="header" style="margin-top:18px;margin-bottom:18px;display:none;">
        <div style="float:left">
             &nbsp;<a href="http://buzzcing.numode-foss.eu" target="_self" style="color:#000000; text-decoration: none;">&nbsp;<img src="/res/AFlogo.png" align="middle" style="position:relative;top:-2px;width:22px;">&nbsp;Buzzcing</a>
             <?PHP if(($CURRENT_VIEW === PRIVATE_VIEW)): ?>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="adminView()" style="color:#000000;">admin mode</a>
             <?PHP endif; ?>
        </div>
   ...
   if (empty($aPlaylistPaths)): ?>
             <div class="blog-content"> 
              <div class="blog-entry" style="background-color:#FFFFFF;">    
                ...
                <?PHP displaySongTitle(0,null,0,null,null,"");?>
              </div> 
             </div>  
          <?PHP $totLinks = 1; ?>
        <?PHP else: ?>
      ...
      foreach ($aPlaylistPaths as $playlistPath) {
        ...
        ?>
                      ...
                      <div class="blog-content"> 
                        <div class="blog-entry" onclick="selectVideo(<?php echo($iEntry-1);?>);" style="ba-ckground-color:<?PHP echo($aBGColors[$iEntry-1]);?>;color:<?PHP echo($aColors[$iEntry-1]);?>;">  
             ...
             echo("<div style='clear:both'>".$playlistName."&nbsp;&nbsp;&nbsp;<br><br><!--<span style='position:relative;top:-4px;'><a href='#' onclick='playList(" . $iEntry ."," . ($CURRENT_VIEW == PUBLIC_VIEW?"false":"true") . ", true);event.stopPropagation();'><img id='playListImg" . $iEntry . "' class='play-list-img2' src='/res/playicon.png' style='width:24px;'></a></span>--></div><br><br>");                       
             ...
             if (empty($aSongPaths)) {
               ...
               foreach ($aSongPaths as $songPath) {
                 ...
                 $txt = file_get_contents($songPath);

                 ?>
                                   
                                              <?PHP if ($orifileExt === "txt"):?>      
                                                      <?PHP $songi++; ?> 
                                                      <?PHP displaySongTitle($iEntry,$songName,$songi,$oriplaylistname,$orisongfilename,$txt); ?>
                                             <?PHP else: ?>
                                                      &nbsp;
                                            <?PHP endif; ?>      
  ...
  function selectVideo(i) {
    ...
    $(".modal-content").each(function(){
      if (y==i) {
        ...
        //  $(this).css("height", "");
        //}
        $(this).css("height", (parseInt(window.innerHeight)  - 300) + "px");
        ...
        s=s.replaceAll("songtxtbase","songtxt");
        ...
        document.getElementsByClassName("blog-entry")[y].style.border = "3px solid red";
      } else {
